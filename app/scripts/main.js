...
/* document.ready? here or before window.load code? */
    ...
    var funFacts = [
    '<p>Have you ever gotten bored with plain old Lemon-Lime or Fruit Punch and opted for a Gatorade X-Factor instead? You can thank NHRT (the National Hybrid Research Team) for that.</p><p>I made my first website back in high school when I established the online presence for our admittedly juvenile social club dedicated to - you guessed it - mixing flavors of Gatorade to create new, better flavors. What I didn\'t guess at the time, however, was that the student body would start visiting the site en masse to read its humorous content. I\'ve been hooked by the power of the web ever since.</p><p>No, NHRT didn\'t reap the financial rewards of such a stroke of mixology brilliance - the idealists we were in high school couldn\'t have been less concerned with intellectual property rights and patents - but we got some serious traffic for a while (one lacrosse coach in Vancouver even implored us to satisfy his team\'s hydration needs) and then all of a sudden Gatorade started producing their own "hybrids". Unfortunately, the site (www.areyoumixing.com) is no longer accessible due to an overhaul of the Tripod free hosting program, but long live the memories and keep on mixing!</p>',
